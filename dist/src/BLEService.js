...
// src/BLEService.ts
var BLEService_exports = {};
__export(BLEService_exports, {
  default: () => BLEService_default
});
module.exports = __toCommonJS(BLEService_exports);
      ...
      this.hardwareSubscription = this.device.monitorCharacteristicForService(
        ...
        (error, characteristic) => {
          ...
          try {
            ...
            const decodedData = (0, import_base_64.decode)(base64Data);
