...
export const backgroundServiceOptions = {
  ...
  foregroundServiceType: ["connectedDevice"] as any,
  parameters: {
    delay: 2000,
  },
};
 ...
 */
export const startBackgroundService = async (options: any = {}) => {
  try {
 ...
 */
export const updatePersistentNotification = async (options: any = {}) => {
  try {
